...
class Matrix2D(object):
    ...
    def flatten(self):
        arr = [
            self._arr[x][y] for y in range(self.cols) for x in range(self.rows)
        ]
        return arr
    ...
    def print(self, name=None):
        ...
        for x in range(self.rows):
            ...
            for y in range(self.cols):
                print("{0:>10.4f}".format(self._arr[x][y]), end=" ")
            print("│")
